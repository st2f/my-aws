...
const resourcesByTagQuery = `query ResourcesByTag($key: String!, $value: String!) {
  resourcesByTag(key: $key, value: $value) {
    arn
    service
    type
    region
...
export function TaggedResourcesRoute() {
  ...
  return (
    <section className="grid gap-5">
      <div>
        <p className="text-sm font-medium text-zinc-500">Tagged resources</p>
